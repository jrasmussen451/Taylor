four51.app.controller('LineItemEditCtrl', ['$scope', '$route', '$routeParams', '$location', 'Product', 'ProductDisplayService', 'Order',
function ($scope, $route, $routeParams, $location, Product, ProductDisplayService, Order) {
